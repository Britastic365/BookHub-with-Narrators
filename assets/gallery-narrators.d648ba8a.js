...
const z={
  ...
  computed:{
    ...
    filteredNarrators() {
      ...
      return this.$store.getters.collection.filter(n => {
        const matchSearch = n.name.toLowerCase().includes(searchLower);
        const matchPopular = !this.filter.popularOnly || n.popular;
      ...
      p("div",{style:m(n.galleryStyle),class:"page-content"},[
        p("div", { class: "filters" }, [
          p("input", {
            ...
            "onUpdate:modelValue": s[0] || (s[0] = $e => r.filter.search = $e)
          }, null, 512),
          p("label", null, [
            p("input", {
              type: "checkbox",
              "onUpdate:modelValue": s[1] || (s[1] = $e => r.filter.popularOnly = $e)
            }),
            y(" Popular Only")
          ])
        ]),
