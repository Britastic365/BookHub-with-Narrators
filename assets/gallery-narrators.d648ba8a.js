...
function D(r,s,a,e,t,n){
  ...
  return r.listReady?(i(),c("div",{key:0,id:"ale-narrators",class:"box-layout-wrapper",style:m(n.optionsOpenMargin),ref:"wrapper"},[u(l,{collectionSource:r.collectionSource,filters:r.filters},null,8,["collectionSource","filters"]),p("div",{style:m(n.galleryStyle),class:"page-content"},[(i(!0),c(N,null,O(r.$store.getters.collection,(o,L)=>(i(),R(f,{class:"single-box","data-name":o.name,key:"narrators:"+o.name},{default:h(()=>[u(g,{to:{name:"narrator",params:{narrator:o.url},query:{subPageSource:r.subPageSource.name}}},{default:h(()=>[p("h2",null,[y(o.name),o.popular?p("span",{class:"popular-star"},"⭐"):d("",!0)]),o.books&&o.books.length?B((i(),c("div",M,[T(y(o.books.length),1)])),[[b,{placement:"right"}]]):d("",!0)]),_:2},1032,["to"])]),_:2},1032,["data-name"]))),128))],4)],4)):d("",!0)}
